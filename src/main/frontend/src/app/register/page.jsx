    ...
    <main className="bg-[url('/img/p11.jpg')] bg-cover">
      ...
      <div className="relative flex justify-center py-8">
        <div style={{ minWidth: "40%" }}>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" onSubmit={createAccount}>
                <div>
                  ...
                  <div className="mt-2">
                    <input id="name" name="name" type="text" autoComplete="name" required className="block w-full rounded-md border-0 py-1.5 px-2 text-black shadow-sm ring-1 ring-inset ring-orange-400 placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6" />
                  </div>
                </div>
          ...
          text-black shadow-sm ring-1 ring-inset ring-orange-400 
          placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-orange-600 
        ...
        text-black shadow-sm ring-1 ring-inset ring-orange-400 px-2
        placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-orange-600 
        sm:text-sm sm:leading-6" />
                  </div>
                </div>
        ...
        shadow-sm ring-1 ring-inset ring-orange-400 placeholder:text-black px-2
        ...
        text-black shadow-sm ring-1 ring-inset ring-orange-400 px-2
        placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 
        sm:text-sm sm:leading-6" />
                  </div>
                </div>
